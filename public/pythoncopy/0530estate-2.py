...
while True :
    try:
        ...
        print(origin)
        #task = (origin[])# .loc 조건식
        origin2 = origin[['부동산개발업상호','지번', '대표자', '도로명주소코드', '도로명주소기타주소', '전화번호', '법정동명', '기타주소']]
        print(origin2)
        ...
        print(origin3)
        origin3.to_excel('C:/Users/skflc/Desktop/0527result/test20-10.xlsx')
        origin3 = origin3[(origin3['기타주소'] != 'NaN')]
        print(origin3)
        origin3.to_excel('C:/Users/skflc/Desktop/0527result/test20-2.xlsx')
        origin4 = origin3[origin3['기타주소'].str.contains('호') == False]
        origin4.to_excel('C:/Users/skflc/Desktop/0527result/test21-2F.xlsx')
        origin5 = origin3[origin3['기타주소'].str.contains('호')]
        print(origin5)
        origin5.to_excel('C:/Users/skflc/Desktop/0527result/test21-2.xlsx')
